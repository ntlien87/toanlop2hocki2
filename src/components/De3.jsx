...
const De3 = () => {
  ...
  const getResult = async (formData) => {
    ...
    if (ans_1 === questions_3[0].dap_an_dung) {
      score += 1;
    }
    if (ans_2 === questions_3[1].dap_an_dung) {
      score += 1;
    }
    if (ans_3 === questions_3[2].dap_an_dung) {
      score += 1;
    }
    if (ans_4 === questions_3[3].dap_an_dung) {
      score += 1;
    }
    if (ans_5 === questions_3[4].dap_an_dung) {
      score += 1;
    }
    if (ans_6 === questions_3[5].dap_an_dung) {
      score += 1;
    }
    if (ans_7 === questions_3[6].dap_an_dung) {
      score += 1;
    }
    if (ans_8 === questions_3[7].dap_an_dung) {
      score += 1;
    }
    if (ans_9 === questions_3[8].dap_an_dung) {
      score += 1;
    }
    if (ans_10 === questions_3[9].dap_an_dung) {
      score += 1;
    }
