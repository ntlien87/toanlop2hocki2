...
import { questions_5 } from "@/libs/lop2/ki2/data";
...
const De5 = () => {
  ...
  const getResult = async (formData) => {
    ...
    if (ans_1 === questions_5[0].dap_an_dung) {
      score += 1;
    }
    if (ans_2 === questions_5[1].dap_an_dung) {
      score += 1;
    }
    if (ans_3 === questions_5[2].dap_an_dung) {
      score += 1;
    }
    if (ans_4 === questions_5[3].dap_an_dung) {
      score += 1;
    }
    if (ans_5 === questions_5[4].dap_an_dung) {
      score += 1;
    }
    if (ans_6 === questions_5[5].dap_an_dung) {
      score += 1;
    }
    if (ans_7 === questions_5[6].dap_an_dung) {
      score += 1;
    }
    if (ans_8 === questions_5[7].dap_an_dung) {
      score += 1;
    }
    if (ans_9 === questions_5[8].dap_an_dung) {
      score += 1;
    }
    if (ans_10 === questions_5[9].dap_an_dung) {
      score += 1;
    }
